...
W1E_LINEAGE_REVISIONS = {W1E_REVISION, CONTINUING_EDUCATION_REVISION}
...
def main() -> None:
            ...
            if current_revision in W1E_LINEAGE_REVISIONS:
                ...
                _verify_vs3_contract(
                    ...
                    include_continuing_education=(
                        current_revision == CONTINUING_EDUCATION_REVISION
                    ),
                )
                _verify_vs4_contract(connection)
                _verify_vs5_contract(connection)
    ...
    if current_revision == CONTINUING_EDUCATION_REVISION:
